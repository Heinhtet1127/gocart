  ...
  return (
    <footer className="bg-white mx-6">
      <div className="mx-auto max-w-7xl">
        <div className="flex md:flex-row flex-col justify-between items-start gap-10 py-10 border-slate-500/30 border-b text-slate-500">
          <div>
            <Link href="/" className="font-semibold text-slate-700 text-4xl">
            ...
            <div className="flex items-center gap-3 mt-5">
              {socialIcons.map((item, i) => (
                <Link
                  href={item.link}
                  key={i}
                  className="flex justify-center items-center bg-slate-100 hover:border border-slate-300 rounded-full w-10 h-10 hover:scale-105 transition"
                >
                  <item.icon />
                </Link>
              ))}
          ...
          <div className="flex flex-wrap justify-between gap-5 w-full md:w-[45%] text-sm">
            {linkSections.map((section, index) => (
              <div key={index}>
                <h3 className="mb-3 md:mb-5 font-medium text-slate-700">
                  {section.title}
                </h3>
